...
func main() {
    ...
    authorizeEditorDataDefinitionsProcessorDefinitionDTO := *openapiclient.NewAuthorizeEditorDataDefinitionsProcessorDefinitionDTO("Name_example") // AuthorizeEditorDataDefinitionsProcessorDefinitionDTO | 
