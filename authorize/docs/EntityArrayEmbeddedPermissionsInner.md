...
`func (o *EntityArrayEmbeddedPermissionsInner) GetLinks() map[string]LinksHATEOASValue`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *EntityArrayEmbeddedPermissionsInner) GetLinksOk() (*map[string]LinksHATEOASValue, bool)`
...
`func (o *EntityArrayEmbeddedPermissionsInner) SetLinks(v map[string]LinksHATEOASValue)`
