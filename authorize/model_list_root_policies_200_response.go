...
// checks if the ListRootPolicies200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListRootPolicies200Response{}

// ListRootPolicies200Response struct for ListRootPolicies200Response
type ListRootPolicies200Response struct {
	Links *map[string]LinksHATEOASValue `json:"_links,omitempty"`
	Embedded *ListRootPolicies200ResponseEmbedded `json:"_embedded,omitempty"`
...
func NewListRootPolicies200Response() *ListRootPolicies200Response {
	this := ListRootPolicies200Response{}
	return &this
}
...
func (o *ListRootPolicies200Response) GetEmbedded() ListRootPolicies200ResponseEmbedded {
	if o == nil || IsNil(o.Embedded) {
		var ret ListRootPolicies200ResponseEmbedded
		return ret
	}
	return *o.Embedded
}
...
// SetEmbedded gets a reference to the given ListRootPolicies200ResponseEmbedded and assigns it to the Embedded field.
...
func (o ListRootPolicies200Response) MarshalJSON() ([]byte, error) {
...
func (o ListRootPolicies200Response) ToMap() (map[string]interface{}, error) {
...
type NullableListRootPolicies200Response struct {
	value *ListRootPolicies200Response
	isSet bool
}

func (v NullableListRootPolicies200Response) Get() *ListRootPolicies200Response {
	return v.value
}

func (v *NullableListRootPolicies200Response) Set(val *ListRootPolicies200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListRootPolicies200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListRootPolicies200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListRootPolicies200Response(val *ListRootPolicies200Response) *NullableListRootPolicies200Response {
	return &NullableListRootPolicies200Response{value: val, isSet: true}
}

func (v NullableListRootPolicies200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListRootPolicies200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
