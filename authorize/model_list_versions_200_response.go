...
// checks if the ListVersions200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListVersions200Response{}

// ListVersions200Response struct for ListVersions200Response
type ListVersions200Response struct {
	Links *map[string]LinksHATEOASValue `json:"_links,omitempty"`
	Embedded *ListVersions200ResponseEmbedded `json:"_embedded,omitempty"`
...
func (o *ListVersions200Response) GetEmbedded() ListVersions200ResponseEmbedded {
	if o == nil || IsNil(o.Embedded) {
		var ret ListVersions200ResponseEmbedded
		return ret
	}
	return *o.Embedded
}
...
// SetEmbedded gets a reference to the given ListVersions200ResponseEmbedded and assigns it to the Embedded field.
...
func (o ListVersions200Response) MarshalJSON() ([]byte, error) {
...
func (o ListVersions200Response) ToMap() (map[string]interface{}, error) {
...
type NullableListVersions200Response struct {
	value *ListVersions200Response
	isSet bool
}

func (v NullableListVersions200Response) Get() *ListVersions200Response {
	return v.value
}

func (v *NullableListVersions200Response) Set(val *ListVersions200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListVersions200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListVersions200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListVersions200Response(val *ListVersions200Response) *NullableListVersions200Response {
	return &NullableListVersions200Response{value: val, isSet: true}
}

func (v NullableListVersions200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListVersions200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
