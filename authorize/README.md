...
For using other server than the one defined on index 0 set context value `authorize.ContextServerIndex` of type `int`.
...
Templated server URL is formatted using default variables from configuration or from context value `authorize.ContextServerVariables` of type `map[string]string`.
...
Similar rules for overriding default operation server index and variables applies by using `authorize.ContextOperationServerIndices` and `authorize.ContextOperationServerVariables` context maps.
...
## Documentation For Models
 ...
 - [ReadAllAPIServerOperations200Response](docs/ReadAllAPIServerOperations200Response.md)
 - [ReadAllAPIServerOperations200ResponseEmbedded](docs/ReadAllAPIServerOperations200ResponseEmbedded.md)
 - [ReadAllAPIServers200Response](docs/ReadAllAPIServers200Response.md)
 - [ReadAllAPIServers200ResponseEmbedded](docs/ReadAllAPIServers200ResponseEmbedded.md)
 - [ReadAllDecisionEndpoints200Response](docs/ReadAllDecisionEndpoints200Response.md)
 - [ReadAllDecisionEndpoints200ResponseEmbedded](docs/ReadAllDecisionEndpoints200ResponseEmbedded.md)
 - [ReadApplicationPermissions200Response](docs/ReadApplicationPermissions200Response.md)
 - [ReadApplicationPermissions200ResponseEmbedded](docs/ReadApplicationPermissions200ResponseEmbedded.md)
 - [ReadApplicationResources200Response](docs/ReadApplicationResources200Response.md)
 - [ReadApplicationResources200ResponseEmbedded](docs/ReadApplicationResources200ResponseEmbedded.md)
 - [ReadApplicationRoleAssignments200Response](docs/ReadApplicationRoleAssignments200Response.md)
 - [ReadApplicationRoleAssignments200ResponseEmbedded](docs/ReadApplicationRoleAssignments200ResponseEmbedded.md)
 - [ReadApplicationRolePermissions200Response](docs/ReadApplicationRolePermissions200Response.md)
 - [ReadApplicationRolePermissions200ResponseEmbedded](docs/ReadApplicationRolePermissions200ResponseEmbedded.md)
 - [ReadApplicationRoles200Response](docs/ReadApplicationRoles200Response.md)
 - [ReadApplicationRoles200ResponseEmbedded](docs/ReadApplicationRoles200ResponseEmbedded.md)
...
```go
auth := context.WithValue(context.Background(), authorize.ContextAccessToken, "BEARER_TOKEN_STRING")
