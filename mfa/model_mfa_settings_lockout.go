...
type _MFASettingsLockout MFASettingsLockout
...
func (o *MFASettingsLockout) UnmarshalJSON(data []byte) (err error) {
	...
	varMFASettingsLockout := _MFASettingsLockout{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	// decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMFASettingsLockout)

	if err != nil {
		return err
	}

	*o = MFASettingsLockout(varMFASettingsLockout)
