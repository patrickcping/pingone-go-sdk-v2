...
type _DeviceAuthenticationPolicyMobileApplicationsInner DeviceAuthenticationPolicyMobileApplicationsInner
...
func (o *DeviceAuthenticationPolicyMobileApplicationsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varDeviceAuthenticationPolicyMobileApplicationsInner := _DeviceAuthenticationPolicyMobileApplicationsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	// decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeviceAuthenticationPolicyMobileApplicationsInner)

	if err != nil {
		return err
	}

	*o = DeviceAuthenticationPolicyMobileApplicationsInner(varDeviceAuthenticationPolicyMobileApplicationsInner)
