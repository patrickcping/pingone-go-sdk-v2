...
`func NewCreateMFAPushCredentialRequest(type_ EnumMFAPushCredentialAttrType, key string, teamId string, token string, googleServiceAccountCredentials string, clientId string, clientSecret string, ) *CreateMFAPushCredentialRequest`
...
`func (o *CreateMFAPushCredentialRequest) GetGoogleServiceAccountCredentials() string`
...
`func (o *CreateMFAPushCredentialRequest) GetGoogleServiceAccountCredentialsOk() (*string, bool)`
...
`func (o *CreateMFAPushCredentialRequest) SetGoogleServiceAccountCredentials(v string)`
