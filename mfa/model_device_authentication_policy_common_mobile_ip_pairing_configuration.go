...
// checks if the DeviceAuthenticationPolicyCommonMobileIpPairingConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceAuthenticationPolicyCommonMobileIpPairingConfiguration{}

// DeviceAuthenticationPolicyCommonMobileIpPairingConfiguration struct for DeviceAuthenticationPolicyCommonMobileIpPairingConfiguration
type DeviceAuthenticationPolicyCommonMobileIpPairingConfiguration struct {
...
func NewDeviceAuthenticationPolicyCommonMobileIpPairingConfiguration() *DeviceAuthenticationPolicyCommonMobileIpPairingConfiguration {
	this := DeviceAuthenticationPolicyCommonMobileIpPairingConfiguration{}
	return &this
}
...
func (o DeviceAuthenticationPolicyCommonMobileIpPairingConfiguration) MarshalJSON() ([]byte, error) {
...
func (o DeviceAuthenticationPolicyCommonMobileIpPairingConfiguration) ToMap() (map[string]interface{}, error) {
...
type NullableDeviceAuthenticationPolicyCommonMobileIpPairingConfiguration struct {
	value *DeviceAuthenticationPolicyCommonMobileIpPairingConfiguration
	isSet bool
}

func (v NullableDeviceAuthenticationPolicyCommonMobileIpPairingConfiguration) Get() *DeviceAuthenticationPolicyCommonMobileIpPairingConfiguration {
	return v.value
}

func (v *NullableDeviceAuthenticationPolicyCommonMobileIpPairingConfiguration) Set(val *DeviceAuthenticationPolicyCommonMobileIpPairingConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceAuthenticationPolicyCommonMobileIpPairingConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceAuthenticationPolicyCommonMobileIpPairingConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceAuthenticationPolicyCommonMobileIpPairingConfiguration(val *DeviceAuthenticationPolicyCommonMobileIpPairingConfiguration) *NullableDeviceAuthenticationPolicyCommonMobileIpPairingConfiguration {
	return &NullableDeviceAuthenticationPolicyCommonMobileIpPairingConfiguration{value: val, isSet: true}
}

func (v NullableDeviceAuthenticationPolicyCommonMobileIpPairingConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceAuthenticationPolicyCommonMobileIpPairingConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
