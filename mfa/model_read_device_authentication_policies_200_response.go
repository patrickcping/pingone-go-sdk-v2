...
// checks if the ReadDeviceAuthenticationPolicies200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReadDeviceAuthenticationPolicies200Response{}
...
func NewReadDeviceAuthenticationPolicies200Response() *ReadDeviceAuthenticationPolicies200Response {
	this := ReadDeviceAuthenticationPolicies200Response{}
	return &this
}
...
func (o ReadDeviceAuthenticationPolicies200Response) hasHalLink(linkIndex string) bool {
...
func (o ReadDeviceAuthenticationPolicies200Response) getHalLink(linkIndex string) LinksHATEOASValue {
	if l, ok := o.GetLinksOk(); ok && l != nil {
		links := l
		if v, ok := links[linkIndex]; ok {
			return v
...
func (o ReadDeviceAuthenticationPolicies200Response) getHalLinkOk(linkIndex string) (*LinksHATEOASValue, bool) {
	if l, ok := o.GetLinksOk(); ok && l != nil {
		links := l
		if v, ok := links[linkIndex]; ok {
			return &v, true
...
func (o ReadDeviceAuthenticationPolicies200Response) IsPaginated() bool {
	return o.hasHalLink(PAGINATION_HAL_LINK_INDEX_NEXT) || o.hasHalLink(PAGINATION_HAL_LINK_INDEX_PREV)
}

func (o ReadDeviceAuthenticationPolicies200Response) HasPaginationSelf() bool {
	return o.hasHalLink(PAGINATION_HAL_LINK_INDEX_SELF)
}

func (o ReadDeviceAuthenticationPolicies200Response) GetPaginationSelfLink() LinksHATEOASValue {
	return o.getHalLink(PAGINATION_HAL_LINK_INDEX_SELF)
}

func (o ReadDeviceAuthenticationPolicies200Response) GetPaginationSelfLinkOk() (*LinksHATEOASValue, bool) {
	return o.getHalLinkOk(PAGINATION_HAL_LINK_INDEX_SELF)
}

func (o ReadDeviceAuthenticationPolicies200Response) HasPaginationNext() bool {
	return o.hasHalLink(PAGINATION_HAL_LINK_INDEX_NEXT)
}

func (o ReadDeviceAuthenticationPolicies200Response) GetPaginationNextLink() LinksHATEOASValue {
	return o.getHalLink(PAGINATION_HAL_LINK_INDEX_NEXT)
}

func (o ReadDeviceAuthenticationPolicies200Response) GetPaginationNextLinkOk() (*LinksHATEOASValue, bool) {
	return o.getHalLinkOk(PAGINATION_HAL_LINK_INDEX_NEXT)
}

func (o ReadDeviceAuthenticationPolicies200Response) HasPaginationPrevious() bool {
	return o.hasHalLink(PAGINATION_HAL_LINK_INDEX_PREV)
}

func (o ReadDeviceAuthenticationPolicies200Response) GetPaginationPreviousLink() LinksHATEOASValue {
	return o.getHalLink(PAGINATION_HAL_LINK_INDEX_PREV)
}

func (o ReadDeviceAuthenticationPolicies200Response) GetPaginationPreviousLinkOk() (*LinksHATEOASValue, bool) {
...
func (o *ReadDeviceAuthenticationPolicies200Response) GetEmbedded() ReadDeviceAuthenticationPolicies200ResponseEmbedded {
	if o == nil || IsNil(o.Embedded) {
		var ret ReadDeviceAuthenticationPolicies200ResponseEmbedded
		return ret
	}
	return *o.Embedded
}
...
// SetEmbedded gets a reference to the given ReadDeviceAuthenticationPolicies200ResponseEmbedded and assigns it to the Embedded field.
...
func (o ReadDeviceAuthenticationPolicies200Response) ToMap() (map[string]interface{}, error) {
...
type NullableReadDeviceAuthenticationPolicies200Response struct {
	value *ReadDeviceAuthenticationPolicies200Response
	isSet bool
}

func (v NullableReadDeviceAuthenticationPolicies200Response) Get() *ReadDeviceAuthenticationPolicies200Response {
	return v.value
}

func (v *NullableReadDeviceAuthenticationPolicies200Response) Set(val *ReadDeviceAuthenticationPolicies200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableReadDeviceAuthenticationPolicies200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableReadDeviceAuthenticationPolicies200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadDeviceAuthenticationPolicies200Response(val *ReadDeviceAuthenticationPolicies200Response) *NullableReadDeviceAuthenticationPolicies200Response {
	return &NullableReadDeviceAuthenticationPolicies200Response{value: val, isSet: true}
}

func (v NullableReadDeviceAuthenticationPolicies200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadDeviceAuthenticationPolicies200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
