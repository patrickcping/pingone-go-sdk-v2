...
type _DeviceAuthenticationPolicyMobile DeviceAuthenticationPolicyMobile
...
func (o *DeviceAuthenticationPolicyMobile) UnmarshalJSON(data []byte) (err error) {
	...
	varDeviceAuthenticationPolicyMobile := _DeviceAuthenticationPolicyMobile{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	// decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeviceAuthenticationPolicyMobile)

	if err != nil {
		return err
	}

	*o = DeviceAuthenticationPolicyMobile(varDeviceAuthenticationPolicyMobile)
