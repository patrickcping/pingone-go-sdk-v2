...
func (o *FIDO2PolicyMdsAuthenticatorsRequirements) UnmarshalJSON(data []byte) (err error) {
	...
	varFIDO2PolicyMdsAuthenticatorsRequirements := _FIDO2PolicyMdsAuthenticatorsRequirements{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	// decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFIDO2PolicyMdsAuthenticatorsRequirements)

	if err != nil {
		return err
	}

	*o = FIDO2PolicyMdsAuthenticatorsRequirements(varFIDO2PolicyMdsAuthenticatorsRequirements)
