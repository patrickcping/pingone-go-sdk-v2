...
type _MFAPushCredentialFCM MFAPushCredentialFCM
...
func (o *MFAPushCredentialFCM) UnmarshalJSON(data []byte) (err error) {
	...
	varMFAPushCredentialFCM := _MFAPushCredentialFCM{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	// decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMFAPushCredentialFCM)

	if err != nil {
		return err
	}

	*o = MFAPushCredentialFCM(varMFAPushCredentialFCM)
