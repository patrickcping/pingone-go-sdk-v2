...
type _PropagationStoreConfigurationAquera PropagationStoreConfigurationAquera
...
func (o *PropagationStoreConfigurationAquera) UnmarshalJSON(bytes []byte) (err error) {
	...
	varPropagationStoreConfigurationAquera := _PropagationStoreConfigurationAquera{}

	err = json.Unmarshal(bytes, &varPropagationStoreConfigurationAquera)

	if err != nil {
		return err
	}

	*o = PropagationStoreConfigurationAquera(varPropagationStoreConfigurationAquera)
