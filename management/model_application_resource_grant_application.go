...
// checks if the ApplicationResourceGrantApplication type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationResourceGrantApplication{}
