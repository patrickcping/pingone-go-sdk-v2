...
// checks if the SignOnPolicyActionAgreementAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SignOnPolicyActionAgreementAllOf{}
...
func (o SignOnPolicyActionAgreementAllOf) ToMap() (map[string]interface{}, error) {
