...
// SignOnPolicyActionProgressiveProfilingAttributesInner struct for SignOnPolicyActionProgressiveProfilingAttributesInner
type SignOnPolicyActionProgressiveProfilingAttributesInner struct {
...
func NewSignOnPolicyActionProgressiveProfilingAttributesInner(name string, required bool) *SignOnPolicyActionProgressiveProfilingAttributesInner {
	this := SignOnPolicyActionProgressiveProfilingAttributesInner{}
	this.Name = name
...
func (o SignOnPolicyActionProgressiveProfilingAttributesInner) MarshalJSON() ([]byte, error) {
...
type NullableSignOnPolicyActionProgressiveProfilingAttributesInner struct {
	value *SignOnPolicyActionProgressiveProfilingAttributesInner
	isSet bool
}

func (v NullableSignOnPolicyActionProgressiveProfilingAttributesInner) Get() *SignOnPolicyActionProgressiveProfilingAttributesInner {
	return v.value
}

func (v *NullableSignOnPolicyActionProgressiveProfilingAttributesInner) Set(val *SignOnPolicyActionProgressiveProfilingAttributesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSignOnPolicyActionProgressiveProfilingAttributesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSignOnPolicyActionProgressiveProfilingAttributesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSignOnPolicyActionProgressiveProfilingAttributesInner(val *SignOnPolicyActionProgressiveProfilingAttributesInner) *NullableSignOnPolicyActionProgressiveProfilingAttributesInner {
	return &NullableSignOnPolicyActionProgressiveProfilingAttributesInner{value: val, isSet: true}
}

func (v NullableSignOnPolicyActionProgressiveProfilingAttributesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSignOnPolicyActionProgressiveProfilingAttributesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
