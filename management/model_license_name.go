...
func (o *LicenseName) UnmarshalJSON(bytes []byte) (err error) {
	...
	varLicenseName := _LicenseName{}

	err = json.Unmarshal(bytes, &varLicenseName)

	if err != nil {
		return err
	}

	*o = LicenseName(varLicenseName)
