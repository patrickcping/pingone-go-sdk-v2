...
type _FormFieldSubmitButton FormFieldSubmitButton
...
func (o *FormFieldSubmitButton) UnmarshalJSON(bytes []byte) (err error) {
	...
	varFormFieldSubmitButton := _FormFieldSubmitButton{}

	err = json.Unmarshal(bytes, &varFormFieldSubmitButton)

	if err != nil {
		return err
	}

	*o = FormFieldSubmitButton(varFormFieldSubmitButton)
