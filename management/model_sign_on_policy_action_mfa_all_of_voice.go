...
// checks if the SignOnPolicyActionMFAAllOfVoice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SignOnPolicyActionMFAAllOfVoice{}
...
func (o SignOnPolicyActionMFAAllOfVoice) ToMap() (map[string]interface{}, error) {
