...
type _ApplicationAccessControlRole ApplicationAccessControlRole
...
func (o *ApplicationAccessControlRole) UnmarshalJSON(bytes []byte) (err error) {
	...
	varApplicationAccessControlRole := _ApplicationAccessControlRole{}

	err = json.Unmarshal(bytes, &varApplicationAccessControlRole)

	if err != nil {
		return err
	}

	*o = ApplicationAccessControlRole(varApplicationAccessControlRole)
