...
type _TemplateContentCommon TemplateContentCommon
...
func (o *TemplateContentCommon) UnmarshalJSON(bytes []byte) (err error) {
	...
	varTemplateContentCommon := _TemplateContentCommon{}

	err = json.Unmarshal(bytes, &varTemplateContentCommon)

	if err != nil {
		return err
	}

	*o = TemplateContentCommon(varTemplateContentCommon)
