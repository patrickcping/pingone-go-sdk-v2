...
// checks if the EnvironmentOrganization type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnvironmentOrganization{}
...
func (o EnvironmentOrganization) ToMap() (map[string]interface{}, error) {
