...
type _NotificationsSettingsPhoneDeliverySettingsCommon NotificationsSettingsPhoneDeliverySettingsCommon
...
func (o *NotificationsSettingsPhoneDeliverySettingsCommon) UnmarshalJSON(bytes []byte) (err error) {
	...
	varNotificationsSettingsPhoneDeliverySettingsCommon := _NotificationsSettingsPhoneDeliverySettingsCommon{}

	err = json.Unmarshal(bytes, &varNotificationsSettingsPhoneDeliverySettingsCommon)

	if err != nil {
		return err
	}

	*o = NotificationsSettingsPhoneDeliverySettingsCommon(varNotificationsSettingsPhoneDeliverySettingsCommon)
