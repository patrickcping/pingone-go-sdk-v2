...
// checks if the GroupPopulation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupPopulation{}
...
type _GroupPopulation GroupPopulation
...
func (o GroupPopulation) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	return toSerialize, nil
}

func (o *GroupPopulation) UnmarshalJSON(bytes []byte) (err error) {
	...
	varGroupPopulation := _GroupPopulation{}

	err = json.Unmarshal(bytes, &varGroupPopulation)

	if err != nil {
		return err
	}

	*o = GroupPopulation(varGroupPopulation)
