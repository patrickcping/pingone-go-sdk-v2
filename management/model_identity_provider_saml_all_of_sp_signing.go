...
type _IdentityProviderSAMLAllOfSpSigning IdentityProviderSAMLAllOfSpSigning
...
func (o *IdentityProviderSAMLAllOfSpSigning) UnmarshalJSON(bytes []byte) (err error) {
	...
	varIdentityProviderSAMLAllOfSpSigning := _IdentityProviderSAMLAllOfSpSigning{}

	err = json.Unmarshal(bytes, &varIdentityProviderSAMLAllOfSpSigning)

	if err != nil {
		return err
	}

	*o = IdentityProviderSAMLAllOfSpSigning(varIdentityProviderSAMLAllOfSpSigning)
