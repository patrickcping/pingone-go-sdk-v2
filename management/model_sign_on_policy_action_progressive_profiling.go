...
type _SignOnPolicyActionProgressiveProfiling SignOnPolicyActionProgressiveProfiling
...
func (o *SignOnPolicyActionProgressiveProfiling) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSignOnPolicyActionProgressiveProfiling := _SignOnPolicyActionProgressiveProfiling{}

	err = json.Unmarshal(bytes, &varSignOnPolicyActionProgressiveProfiling)

	if err != nil {
		return err
	}

	*o = SignOnPolicyActionProgressiveProfiling(varSignOnPolicyActionProgressiveProfiling)
