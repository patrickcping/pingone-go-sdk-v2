...
// IdentityProviderGoogle struct for IdentityProviderGoogle
...
func (o IdentityProviderGoogle) MarshalJSON() ([]byte, error) {
...
type NullableIdentityProviderGoogle struct {
	value *IdentityProviderGoogle
	isSet bool
}

func (v NullableIdentityProviderGoogle) Get() *IdentityProviderGoogle {
	return v.value
}

func (v *NullableIdentityProviderGoogle) Set(val *IdentityProviderGoogle) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentityProviderGoogle) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentityProviderGoogle) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentityProviderGoogle(val *IdentityProviderGoogle) *NullableIdentityProviderGoogle {
	return &NullableIdentityProviderGoogle{value: val, isSet: true}
}

func (v NullableIdentityProviderGoogle) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentityProviderGoogle) UnmarshalJSON(src []byte) error {
	v.isSet = true
