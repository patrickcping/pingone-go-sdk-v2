...
type _ApplicationOIDC ApplicationOIDC
...
func (o *ApplicationOIDC) UnmarshalJSON(bytes []byte) (err error) {
	...
	varApplicationOIDC := _ApplicationOIDC{}

	err = json.Unmarshal(bytes, &varApplicationOIDC)

	if err != nil {
		return err
	}

	*o = ApplicationOIDC(varApplicationOIDC)
