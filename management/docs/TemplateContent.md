...
`func NewTemplateContent(locale string, deliveryMethod EnumTemplateContentDeliveryMethod, body string, content string, ) *TemplateContent`
...
`func (o *TemplateContent) HasTitle() bool`
