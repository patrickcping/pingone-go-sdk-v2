...
`func (o *NotificationsSettingsPhoneDeliverySettings) GetLinks() map[string]LinksHATEOASValue`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *NotificationsSettingsPhoneDeliverySettings) GetLinksOk() (*map[string]LinksHATEOASValue, bool)`
...
`func (o *NotificationsSettingsPhoneDeliverySettings) SetLinks(v map[string]LinksHATEOASValue)`

SetLinks sets Links field to given value.

### HasLinks

`func (o *NotificationsSettingsPhoneDeliverySettings) HasLinks() bool`
