...
------------ | ------------- | ------------- | -------------
**Url** | Pointer to **string** | A string that specifies a valid URL to which event messages are sent. This is a required property. | [optional] 
...
`func NewSubscriptionConnectionDetails() *SubscriptionConnectionDetails`
...
`func (o *SubscriptionConnectionDetails) HasUrl() bool`
