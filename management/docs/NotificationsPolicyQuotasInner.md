...
**DeliveryMethods** | [**[]EnumNotificationsPolicyQuotaDeliveryMethods**](EnumNotificationsPolicyQuotaDeliveryMethods.md) | The delivery methods for which the limit is being defined. Currently, the content of the array must be &#x60;SMS&#x60;, &#x60;Voice&#x60;. This means that the combined total of SMS and Voice notifications must be below the limit defined. | 
