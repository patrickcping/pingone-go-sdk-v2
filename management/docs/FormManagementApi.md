...
> Form CreateForm(ctx, environmentID).XPingExternalTransactionID(xPingExternalTransactionID).XPingExternalSessionID(xPingExternalSessionID).Form(form).Execute()
...
func main() {
    ...
    form := *openapiclient.NewForm(openapiclient.EnumFormCategory("CUSTOM"), *openapiclient.NewFormComponents([]openapiclient.FormField{openapiclient.FormField{FormFieldCheckbox: openapiclient.NewFormFieldCheckbox(openapiclient.EnumFormFieldType("TEXT"), *openapiclient.NewFormFieldCommonPosition(int32(123), int32(123)), "Key_example", "Label_example", openapiclient.EnumFormElementLayout("HORIZONTAL"), []openapiclient.FormElementOption{*openapiclient.NewFormElementOption("Label_example", "Value_example")})}}), false, false, "Name_example") // Form |  (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.FormManagementApi.CreateForm(context.Background(), environmentID).XPingExternalTransactionID(xPingExternalTransactionID).XPingExternalSessionID(xPingExternalSessionID).Form(form).Execute()
    if err != nil {
...
> DeleteForm(ctx, environmentID, formID).XPingExternalTransactionID(xPingExternalTransactionID).XPingExternalSessionID(xPingExternalSessionID).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.FormManagementApi.DeleteForm(context.Background(), environmentID, formID).XPingExternalTransactionID(xPingExternalTransactionID).XPingExternalSessionID(xPingExternalSessionID).Execute()
    if err != nil {
...
> EntityArrayPagedIterator ReadAllForms(ctx, environmentID).XPingExternalTransactionID(xPingExternalTransactionID).XPingExternalSessionID(xPingExternalSessionID).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.FormManagementApi.ReadAllForms(context.Background(), environmentID).XPingExternalTransactionID(xPingExternalTransactionID).XPingExternalSessionID(xPingExternalSessionID).Execute()
    if err != nil {
...
> Form ReadForm(ctx, environmentID, formID).XPingExternalTransactionID(xPingExternalTransactionID).XPingExternalSessionID(xPingExternalSessionID).Include(include).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.FormManagementApi.ReadForm(context.Background(), environmentID, formID).XPingExternalTransactionID(xPingExternalTransactionID).XPingExternalSessionID(xPingExternalSessionID).Include(include).Execute()
    if err != nil {
...
> Form UpdateForm(ctx, environmentID, formID).XPingExternalTransactionID(xPingExternalTransactionID).XPingExternalSessionID(xPingExternalSessionID).Form(form).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.FormManagementApi.UpdateForm(context.Background(), environmentID, formID).XPingExternalTransactionID(xPingExternalTransactionID).XPingExternalSessionID(xPingExternalSessionID).Form(form).Execute()
    if err != nil {
