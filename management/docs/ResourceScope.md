...
**EnableMappedClaims** | Pointer to **bool** | A Boolean that enables attribute mapping in scopes to control the attributes included in access tokens. If this property is not set or set to &#x60;false&#x60; (default), the access token includes all custom attribute claims. When set to &#x60;true&#x60;, the access token includes only the claims mapped in the scope. | [optional] 
...
### GetEnableMappedClaims

`func (o *ResourceScope) GetEnableMappedClaims() bool`

GetEnableMappedClaims returns the EnableMappedClaims field if non-nil, zero value otherwise.

### GetEnableMappedClaimsOk

`func (o *ResourceScope) GetEnableMappedClaimsOk() (*bool, bool)`

GetEnableMappedClaimsOk returns a tuple with the EnableMappedClaims field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetEnableMappedClaims

`func (o *ResourceScope) SetEnableMappedClaims(v bool)`

SetEnableMappedClaims sets EnableMappedClaims field to given value.

### HasEnableMappedClaims
