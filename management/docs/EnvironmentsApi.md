...
func main() {
    environment := *openapiclient.NewEnvironment(*openapiclient.NewEnvironmentLicense("Id_example"), "Name_example", "Region_example", openapiclient.EnumEnvironmentType("PRODUCTION")) // Environment |  (optional)
