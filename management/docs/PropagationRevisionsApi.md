...
> EnvironmentsEnvironmentIDPropagationRevisionsIdlatestGet(ctx, environmentID).Accept(accept).XPingExternalTransactionID(xPingExternalTransactionID).XPingExternalSessionID(xPingExternalSessionID).Execute()
...
func main() {
    ...
    r, err := apiClient.PropagationRevisionsApi.EnvironmentsEnvironmentIDPropagationRevisionsIdlatestGet(context.Background(), environmentID).Accept(accept).XPingExternalTransactionID(xPingExternalTransactionID).XPingExternalSessionID(xPingExternalSessionID).Execute()
    if err != nil {
...
> EnvironmentsEnvironmentIDPropagationRevisionsPost(ctx, environmentID).XPingExternalTransactionID(xPingExternalTransactionID).XPingExternalSessionID(xPingExternalSessionID).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.PropagationRevisionsApi.EnvironmentsEnvironmentIDPropagationRevisionsPost(context.Background(), environmentID).XPingExternalTransactionID(xPingExternalTransactionID).XPingExternalSessionID(xPingExternalSessionID).Execute()
    if err != nil {
...
> EnvironmentsEnvironmentIDPropagationRevisionsPreviousRevisionIDGet(ctx, environmentID, previousRevisionID).Accept(accept).XPingExternalTransactionID(xPingExternalTransactionID).XPingExternalSessionID(xPingExternalSessionID).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.PropagationRevisionsApi.EnvironmentsEnvironmentIDPropagationRevisionsPreviousRevisionIDGet(context.Background(), environmentID, previousRevisionID).Accept(accept).XPingExternalTransactionID(xPingExternalTransactionID).XPingExternalSessionID(xPingExternalSessionID).Execute()
    if err != nil {
