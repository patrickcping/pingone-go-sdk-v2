...
`func NewEntityArrayEmbeddedGatewaysInner(name string, type_ EnumGatewayType, enabled bool, bindDN string, bindPassword string, userTypes []GatewayLDAPAllOfUserTypes, vendor string, ) *EntityArrayEmbeddedGatewaysInner`
