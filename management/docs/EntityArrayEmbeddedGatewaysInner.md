...
`func NewEntityArrayEmbeddedGatewaysInner(name string, type_ EnumGatewayType, enabled bool, bindDN string, bindPassword string, serversHostAndPort []string, vendor EnumGatewayVendor, ) *EntityArrayEmbeddedGatewaysInner`
