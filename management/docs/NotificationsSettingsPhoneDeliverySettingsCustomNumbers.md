...
**Capabilities** | [**[]EnumNotificationsSettingsPhoneDeliverySettingsCustomNumbersCapability**](EnumNotificationsSettingsPhoneDeliverySettingsCustomNumbersCapability.md) | A collection of the phone delivery service capabilities. | 
