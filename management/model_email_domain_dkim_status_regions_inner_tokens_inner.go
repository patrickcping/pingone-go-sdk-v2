...
// checks if the EmailDomainDKIMStatusRegionsInnerTokensInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmailDomainDKIMStatusRegionsInnerTokensInner{}
...
func (o EmailDomainDKIMStatusRegionsInnerTokensInner) ToMap() (map[string]interface{}, error) {
