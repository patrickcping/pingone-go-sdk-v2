...
*/
func (a *AgreementManagementAgreementRevisionsResourcesApiService) CreateAgreementLanguageRevision(ctx context.Context, environmentID string, agreementID string, languageID string) ApiCreateAgreementLanguageRevisionRequest {
	return ApiCreateAgreementLanguageRevisionRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *AgreementManagementAgreementRevisionsResourcesApiService) CreateAgreementLanguageRevisionExecute(r ApiCreateAgreementLanguageRevisionRequest) (*AgreementLanguageRevision, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AgreementManagementAgreementRevisionsResourcesApiService.CreateAgreementLanguageRevision")
	if err != nil {
...
*/
func (a *AgreementManagementAgreementRevisionsResourcesApiService) DeleteAgreementLanguageRevision(ctx context.Context, environmentID string, agreementID string, languageID string, revisionID string) ApiDeleteAgreementLanguageRevisionRequest {
	return ApiDeleteAgreementLanguageRevisionRequest{
		ApiService: a,
		ctx: ctx,
		environmentID: environmentID,
...
// Execute executes the request
func (a *AgreementManagementAgreementRevisionsResourcesApiService) DeleteAgreementLanguageRevisionExecute(r ApiDeleteAgreementLanguageRevisionRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AgreementManagementAgreementRevisionsResourcesApiService.DeleteAgreementLanguageRevision")
	if err != nil {
...
*/
func (a *AgreementManagementAgreementRevisionsResourcesApiService) ReadAllAgreementLanguageRevisions(ctx context.Context, environmentID string, agreementID string, languageID string) ApiReadAllAgreementLanguageRevisionsRequest {
	return ApiReadAllAgreementLanguageRevisionsRequest{
		ApiService: a,
		ctx: ctx,
		environmentID: environmentID,
...
// Execute executes the request
//  @return EntityArray
func (a *AgreementManagementAgreementRevisionsResourcesApiService) ReadAllAgreementLanguageRevisionsExecute(r ApiReadAllAgreementLanguageRevisionsRequest) (*EntityArray, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AgreementManagementAgreementRevisionsResourcesApiService.ReadAllAgreementLanguageRevisions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *AgreementManagementAgreementRevisionsResourcesApiService) ReadOneAgreementLanguageRevision(ctx context.Context, environmentID string, agreementID string, languageID string, revisionID string) ApiReadOneAgreementLanguageRevisionRequest {
	return ApiReadOneAgreementLanguageRevisionRequest{
		ApiService: a,
		ctx: ctx,
		environmentID: environmentID,
...
// Execute executes the request
//  @return AgreementLanguageRevision
func (a *AgreementManagementAgreementRevisionsResourcesApiService) ReadOneAgreementLanguageRevisionExecute(r ApiReadOneAgreementLanguageRevisionRequest) (*AgreementLanguageRevision, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AgreementManagementAgreementRevisionsResourcesApiService.ReadOneAgreementLanguageRevision")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
