...
*ApplicationMetadataApi* | [**ReadApplicationMetadata**](docs/ApplicationMetadataApi.md#readapplicationmetadata) | **Get** /environments/{environmentID}/applications/{applicationID}/metadata | READ Application Metadata
*ApplicationMetadataApi* | [**UpdateApplicationMetadata**](docs/ApplicationMetadataApi.md#updateapplicationmetadata) | **Put** /environments/{environmentID}/applications/{applicationID}/metadata | UPDATE Application Metadata
...
## Documentation For Models
 ...
 - [ApplicationOIDCAllOfMobilePush](docs/ApplicationOIDCAllOfMobilePush.md)
 - [ApplicationOIDCAllOfMobilePushNumberMatching](docs/ApplicationOIDCAllOfMobilePushNumberMatching.md)
 ...
 - [AuthenticationDevice](docs/AuthenticationDevice.md)
 ...
 - [BrandingThemeConfigurationLocalizedText](docs/BrandingThemeConfigurationLocalizedText.md)
 - [BrandingThemeConfigurationLocalizedTextContent](docs/BrandingThemeConfigurationLocalizedTextContent.md)
 ...
 - [EnumApplicationOIDCRefreshTokenType](docs/EnumApplicationOIDCRefreshTokenType.md)
 ...
 - [EnumApplicationPushNumberMatchingType](docs/EnumApplicationPushNumberMatchingType.md)
 ...
 - [EnumBrandingThemeLocalizedContentType](docs/EnumBrandingThemeLocalizedContentType.md)
 ...
 - [EnumFormAgreementInputType](docs/EnumFormAgreementInputType.md)
 - [EnumFormAuthenticationDeviceType](docs/EnumFormAuthenticationDeviceType.md)
 ...
 - [EnumFormFIDO2Action](docs/EnumFormFIDO2Action.md)
 - [EnumFormFIDO2Trigger](docs/EnumFormFIDO2Trigger.md)
 - [EnumFormFieldType](docs/EnumFormFieldType.md)
 - [EnumFormFieldVisibility](docs/EnumFormFieldVisibility.md)
 - [EnumFormItemAlignment](docs/EnumFormItemAlignment.md)
 - [EnumFormItemIconSize](docs/EnumFormItemIconSize.md)
 - [EnumFormItemIconType](docs/EnumFormItemIconType.md)
 - [EnumFormItemSize](docs/EnumFormItemSize.md)
 - [EnumFormPollingAppearance](docs/EnumFormPollingAppearance.md)
 - [EnumFormRecaptchaV2Size](docs/EnumFormRecaptchaV2Size.md)
 - [EnumFormRecaptchaV2Theme](docs/EnumFormRecaptchaV2Theme.md)
 - [EnumFormRegistrationDeviceType](docs/EnumFormRegistrationDeviceType.md)
 - [EnumFormSingleCheckboxAppearance](docs/EnumFormSingleCheckboxAppearance.md)
 - [EnumFormSingleCheckboxInputType](docs/EnumFormSingleCheckboxInputType.md)
 ...
 - [EnumNotificationsPolicyCooldownConfigurationMethodPeriodTimeUnit](docs/EnumNotificationsPolicyCooldownConfigurationMethodPeriodTimeUnit.md)
 ...
 - [EnumNotificationsPolicyProviderConfigurationConditionsDeliveryMethods](docs/EnumNotificationsPolicyProviderConfigurationConditionsDeliveryMethods.md)
 ...
 - [EnumNotificationsSettingsPhoneDeliverySettingsCustomAuthClientAuthenticationMethod](docs/EnumNotificationsSettingsPhoneDeliverySettingsCustomAuthClientAuthenticationMethod.md)
 - [EnumNotificationsSettingsPhoneDeliverySettingsCustomAuthGrantType](docs/EnumNotificationsSettingsPhoneDeliverySettingsCustomAuthGrantType.md)
 ...
 - [EnumSubscriptionPayloadFormatHttpsFormat](docs/EnumSubscriptionPayloadFormatHttpsFormat.md)
 - [EnumSubscriptionPayloadFormatTcpFormat](docs/EnumSubscriptionPayloadFormatTcpFormat.md)
 - [EnumSubscriptionPayloadOptionsMaximumPayloadLimitType](docs/EnumSubscriptionPayloadOptionsMaximumPayloadLimitType.md)
 - [EnumSubscriptionProtocol](docs/EnumSubscriptionProtocol.md)
 ...
 - [FormFieldCommonVisibility](docs/FormFieldCommonVisibility.md)
 - [FormFieldDeviceAuthentication](docs/FormFieldDeviceAuthentication.md)
 - [FormFieldDeviceRegistration](docs/FormFieldDeviceRegistration.md)
 ...
 - [FormFieldSingleCheckbox](docs/FormFieldSingleCheckbox.md)
 ...
 - [FormFieldWithKey](docs/FormFieldWithKey.md)
 - [FormFlowButton](docs/FormFlowButton.md)
 - [FormFlowButtonStyles](docs/FormFlowButtonStyles.md)
 - [FormItem](docs/FormItem.md)
 - [FormItemWithIcon](docs/FormItemWithIcon.md)
 - [FormItemWithIconAllOfIcon](docs/FormItemWithIconAllOfIcon.md)
 ...
 - [FormSingleCheckbox](docs/FormSingleCheckbox.md)
 - [FormSocialLoginButton](docs/FormSocialLoginButton.md)
 - [FormSocialLoginButtonAllOfStyles](docs/FormSocialLoginButtonAllOfStyles.md)
 ...
 - [NotificationsPolicyCooldownConfiguration](docs/NotificationsPolicyCooldownConfiguration.md)
 - [NotificationsPolicyCooldownConfigurationMethod](docs/NotificationsPolicyCooldownConfigurationMethod.md)
 - [NotificationsPolicyCooldownConfigurationMethodPeriodsInner](docs/NotificationsPolicyCooldownConfigurationMethodPeriodsInner.md)
 - [NotificationsPolicyCountryLimit](docs/NotificationsPolicyCountryLimit.md)
 - [NotificationsPolicyProviderConfiguration](docs/NotificationsPolicyProviderConfiguration.md)
 - [NotificationsPolicyProviderConfigurationConditionsInner](docs/NotificationsPolicyProviderConfigurationConditionsInner.md)
 - [NotificationsPolicyProviderConfigurationConditionsInnerFallbackChainInner](docs/NotificationsPolicyProviderConfigurationConditionsInnerFallbackChainInner.md)
 ...
 - [PasswordPolicyAlphabetSequenceRule](docs/PasswordPolicyAlphabetSequenceRule.md)
 ...
 - [PasswordPolicyNumberSequenceRule](docs/PasswordPolicyNumberSequenceRule.md)
 - [PasswordPolicyQwertySequenceRule](docs/PasswordPolicyQwertySequenceRule.md)
 - [PasswordPolicyShiftedNumberRowSequenceRule](docs/PasswordPolicyShiftedNumberRowSequenceRule.md)
 ...
 - [RegistrationDevice](docs/RegistrationDevice.md)
 ...
 - [SubscriptionConnectionDetails](docs/SubscriptionConnectionDetails.md)
 ...
 - [SubscriptionPayloadOptions](docs/SubscriptionPayloadOptions.md)
 - [SubscriptionPayloadOptionsMaximumPayloadLimit](docs/SubscriptionPayloadOptionsMaximumPayloadLimit.md)
 - [SubscriptionPayloadOptionsPayloadFormat](docs/SubscriptionPayloadOptionsPayloadFormat.md)
 - [SubscriptionPayloadOptionsPayloadFormatHttps](docs/SubscriptionPayloadOptionsPayloadFormatHttps.md)
 - [SubscriptionPayloadOptionsPayloadFormatTcp](docs/SubscriptionPayloadOptionsPayloadFormatTcp.md)
