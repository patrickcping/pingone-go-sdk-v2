...
type _SchemaAttributeRegexValidation SchemaAttributeRegexValidation
...
func (o *SchemaAttributeRegexValidation) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSchemaAttributeRegexValidation := _SchemaAttributeRegexValidation{}

	err = json.Unmarshal(bytes, &varSchemaAttributeRegexValidation)

	if err != nil {
		return err
	}

	*o = SchemaAttributeRegexValidation(varSchemaAttributeRegexValidation)
