...
type _SignOnPolicyActionCommonConditionIPRiskIpRisk SignOnPolicyActionCommonConditionIPRiskIpRisk
...
func (o *SignOnPolicyActionCommonConditionIPRiskIpRisk) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSignOnPolicyActionCommonConditionIPRiskIpRisk := _SignOnPolicyActionCommonConditionIPRiskIpRisk{}

	err = json.Unmarshal(bytes, &varSignOnPolicyActionCommonConditionIPRiskIpRisk)

	if err != nil {
		return err
	}

	*o = SignOnPolicyActionCommonConditionIPRiskIpRisk(varSignOnPolicyActionCommonConditionIPRiskIpRisk)
