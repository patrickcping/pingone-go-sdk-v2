...
// checks if the BrandingThemeConfigurationLogo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BrandingThemeConfigurationLogo{}
...
type _BrandingThemeConfigurationLogo BrandingThemeConfigurationLogo
...
func (o BrandingThemeConfigurationLogo) ToMap() (map[string]interface{}, error) {
...
func (o *BrandingThemeConfigurationLogo) UnmarshalJSON(bytes []byte) (err error) {
	...
	varBrandingThemeConfigurationLogo := _BrandingThemeConfigurationLogo{}

	err = json.Unmarshal(bytes, &varBrandingThemeConfigurationLogo)

	if err != nil {
		return err
	}

	*o = BrandingThemeConfigurationLogo(varBrandingThemeConfigurationLogo)
