...
func (dst *IdentityProvider) UnmarshalJSON(data []byte) error {
	...
	// try to unmarshal data into IdentityProviderClientIDClientSecret
	err = newStrictDecoder(data).Decode(&dst.IdentityProviderClientIDClientSecret)
	if err == nil {
		jsonIdentityProviderClientIDClientSecret, _ := json.Marshal(dst.IdentityProviderClientIDClientSecret)
		if string(jsonIdentityProviderClientIDClientSecret) == "{}" { // empty struct
