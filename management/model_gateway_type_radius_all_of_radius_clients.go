...
type _GatewayTypeRADIUSAllOfRadiusClients GatewayTypeRADIUSAllOfRadiusClients
...
func (o *GatewayTypeRADIUSAllOfRadiusClients) UnmarshalJSON(bytes []byte) (err error) {
	...
	varGatewayTypeRADIUSAllOfRadiusClients := _GatewayTypeRADIUSAllOfRadiusClients{}

	err = json.Unmarshal(bytes, &varGatewayTypeRADIUSAllOfRadiusClients)

	if err != nil {
		return err
	}

	*o = GatewayTypeRADIUSAllOfRadiusClients(varGatewayTypeRADIUSAllOfRadiusClients)
