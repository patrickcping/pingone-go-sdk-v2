...
type _ApplicationResourceGrantResource ApplicationResourceGrantResource
...
func (o *ApplicationResourceGrantResource) UnmarshalJSON(bytes []byte) (err error) {
	...
	varApplicationResourceGrantResource := _ApplicationResourceGrantResource{}

	err = json.Unmarshal(bytes, &varApplicationResourceGrantResource)

	if err != nil {
		return err
	}

	*o = ApplicationResourceGrantResource(varApplicationResourceGrantResource)
