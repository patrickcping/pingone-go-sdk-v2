...
type _CertificateKeyUpdate CertificateKeyUpdate
...
func (o *CertificateKeyUpdate) UnmarshalJSON(bytes []byte) (err error) {
	...
	varCertificateKeyUpdate := _CertificateKeyUpdate{}

	err = json.Unmarshal(bytes, &varCertificateKeyUpdate)

	if err != nil {
		return err
	}

	*o = CertificateKeyUpdate(varCertificateKeyUpdate)
