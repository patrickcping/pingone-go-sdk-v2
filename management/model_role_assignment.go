...
type _RoleAssignment RoleAssignment
...
func (o *RoleAssignment) UnmarshalJSON(bytes []byte) (err error) {
	...
	varRoleAssignment := _RoleAssignment{}

	err = json.Unmarshal(bytes, &varRoleAssignment)

	if err != nil {
		return err
	}

	*o = RoleAssignment(varRoleAssignment)
