...
type _FormFieldRadio FormFieldRadio
...
func (o *FormFieldRadio) UnmarshalJSON(bytes []byte) (err error) {
	...
	varFormFieldRadio := _FormFieldRadio{}

	err = json.Unmarshal(bytes, &varFormFieldRadio)

	if err != nil {
		return err
	}

	*o = FormFieldRadio(varFormFieldRadio)
