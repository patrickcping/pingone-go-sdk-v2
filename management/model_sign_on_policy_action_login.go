...
type _SignOnPolicyActionLogin SignOnPolicyActionLogin
...
func (o *SignOnPolicyActionLogin) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSignOnPolicyActionLogin := _SignOnPolicyActionLogin{}

	err = json.Unmarshal(bytes, &varSignOnPolicyActionLogin)

	if err != nil {
		return err
	}

	*o = SignOnPolicyActionLogin(varSignOnPolicyActionLogin)
