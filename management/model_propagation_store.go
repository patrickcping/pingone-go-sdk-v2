...
type _PropagationStore PropagationStore
...
func (o *PropagationStore) UnmarshalJSON(bytes []byte) (err error) {
	...
	varPropagationStore := _PropagationStore{}

	err = json.Unmarshal(bytes, &varPropagationStore)

	if err != nil {
		return err
	}

	*o = PropagationStore(varPropagationStore)
