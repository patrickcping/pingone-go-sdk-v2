...
// checks if the RegistrationDevice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegistrationDevice{}
...
func (o RegistrationDevice) MarshalJSON() ([]byte, error) {
...
func (o RegistrationDevice) ToMap() (map[string]interface{}, error) {
...
type NullableRegistrationDevice struct {
	value *RegistrationDevice
	isSet bool
}

func (v NullableRegistrationDevice) Get() *RegistrationDevice {
	return v.value
}

func (v *NullableRegistrationDevice) Set(val *RegistrationDevice) {
	v.value = val
	v.isSet = true
}

func (v NullableRegistrationDevice) IsSet() bool {
	return v.isSet
}

func (v *NullableRegistrationDevice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegistrationDevice(val *RegistrationDevice) *NullableRegistrationDevice {
	return &NullableRegistrationDevice{value: val, isSet: true}
}

func (v NullableRegistrationDevice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegistrationDevice) UnmarshalJSON(src []byte) error {
	v.isSet = true
