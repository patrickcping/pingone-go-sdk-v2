...
// checks if the SignOnPolicyActionCommonConditionAnd type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SignOnPolicyActionCommonConditionAnd{}
...
func (o SignOnPolicyActionCommonConditionAnd) ToMap() (map[string]interface{}, error) {
