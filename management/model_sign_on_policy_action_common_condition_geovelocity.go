...
type _SignOnPolicyActionCommonConditionGeovelocity SignOnPolicyActionCommonConditionGeovelocity
...
func (o *SignOnPolicyActionCommonConditionGeovelocity) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSignOnPolicyActionCommonConditionGeovelocity := _SignOnPolicyActionCommonConditionGeovelocity{}

	err = json.Unmarshal(bytes, &varSignOnPolicyActionCommonConditionGeovelocity)

	if err != nil {
		return err
	}

	*o = SignOnPolicyActionCommonConditionGeovelocity(varSignOnPolicyActionCommonConditionGeovelocity)
