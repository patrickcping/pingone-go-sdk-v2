...
var _ MappedNullable = &SignOnPolicyActionLoginAllOfRegistrationPopulation{}
...
func (o SignOnPolicyActionLoginAllOfRegistrationPopulation) ToMap() (map[string]interface{}, error) {
