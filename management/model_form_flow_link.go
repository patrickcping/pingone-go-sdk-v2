...
type _FormFlowLink FormFlowLink
...
func (o *FormFlowLink) UnmarshalJSON(bytes []byte) (err error) {
	...
	varFormFlowLink := _FormFlowLink{}

	err = json.Unmarshal(bytes, &varFormFlowLink)

	if err != nil {
		return err
	}

	*o = FormFlowLink(varFormFlowLink)
