...
type _FormFieldPassword FormFieldPassword
...
func (o *FormFieldPassword) UnmarshalJSON(bytes []byte) (err error) {
	...
	varFormFieldPassword := _FormFieldPassword{}

	err = json.Unmarshal(bytes, &varFormFieldPassword)

	if err != nil {
		return err
	}

	*o = FormFieldPassword(varFormFieldPassword)
