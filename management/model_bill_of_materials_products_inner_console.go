...
type _BillOfMaterialsProductsInnerConsole BillOfMaterialsProductsInnerConsole
...
func (o *BillOfMaterialsProductsInnerConsole) UnmarshalJSON(bytes []byte) (err error) {
	...
	varBillOfMaterialsProductsInnerConsole := _BillOfMaterialsProductsInnerConsole{}

	err = json.Unmarshal(bytes, &varBillOfMaterialsProductsInnerConsole)

	if err != nil {
		return err
	}

	*o = BillOfMaterialsProductsInnerConsole(varBillOfMaterialsProductsInnerConsole)
