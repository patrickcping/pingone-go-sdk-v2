...
type _SignOnPolicyActionIDFirst SignOnPolicyActionIDFirst
...
func (o *SignOnPolicyActionIDFirst) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSignOnPolicyActionIDFirst := _SignOnPolicyActionIDFirst{}

	err = json.Unmarshal(bytes, &varSignOnPolicyActionIDFirst)

	if err != nil {
		return err
	}

	*o = SignOnPolicyActionIDFirst(varSignOnPolicyActionIDFirst)
