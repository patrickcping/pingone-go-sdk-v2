...
type _LanguageLocalizationStatus LanguageLocalizationStatus
...
func (o *LanguageLocalizationStatus) UnmarshalJSON(bytes []byte) (err error) {
	...
	varLanguageLocalizationStatus := _LanguageLocalizationStatus{}

	err = json.Unmarshal(bytes, &varLanguageLocalizationStatus)

	if err != nil {
		return err
	}

	*o = LanguageLocalizationStatus(varLanguageLocalizationStatus)
