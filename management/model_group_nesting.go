...
type _GroupNesting GroupNesting
...
func (o *GroupNesting) UnmarshalJSON(bytes []byte) (err error) {
	...
	varGroupNesting := _GroupNesting{}

	err = json.Unmarshal(bytes, &varGroupNesting)

	if err != nil {
		return err
	}

	*o = GroupNesting(varGroupNesting)
