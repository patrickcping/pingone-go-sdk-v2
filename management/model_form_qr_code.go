...
func (o *FormQrCode) UnmarshalJSON(bytes []byte) (err error) {
	...
	varFormQrCode := _FormQrCode{}

	err = json.Unmarshal(bytes, &varFormQrCode)

	if err != nil {
		return err
	}

	*o = FormQrCode(varFormQrCode)
