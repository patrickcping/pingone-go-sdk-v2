...
type _SignOnPolicy SignOnPolicy
...
func (o *SignOnPolicy) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSignOnPolicy := _SignOnPolicy{}

	err = json.Unmarshal(bytes, &varSignOnPolicy)

	if err != nil {
		return err
	}

	*o = SignOnPolicy(varSignOnPolicy)
