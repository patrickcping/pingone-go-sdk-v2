...
// checks if the ReadOneDigitalWalletCredential200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReadOneDigitalWalletCredential200Response{}
...
func NewReadOneDigitalWalletCredential200Response() *ReadOneDigitalWalletCredential200Response {
	this := ReadOneDigitalWalletCredential200Response{}
	return &this
}
...
func (o ReadOneDigitalWalletCredential200Response) IsPaginated() bool {
	return o.hasHalLink(PAGINATION_HAL_LINK_INDEX_NEXT) || o.hasHalLink(PAGINATION_HAL_LINK_INDEX_PREV)
}

func (o ReadOneDigitalWalletCredential200Response) HasPaginationSelf() bool {
	return o.hasHalLink(PAGINATION_HAL_LINK_INDEX_SELF)
}

func (o ReadOneDigitalWalletCredential200Response) GetPaginationSelfLink() LinksHATEOASValue {
	return o.getHalLink(PAGINATION_HAL_LINK_INDEX_SELF)
}

func (o ReadOneDigitalWalletCredential200Response) GetPaginationSelfLinkOk() (*LinksHATEOASValue, bool) {
	return o.getHalLinkOk(PAGINATION_HAL_LINK_INDEX_SELF)
}

func (o ReadOneDigitalWalletCredential200Response) HasPaginationNext() bool {
	return o.hasHalLink(PAGINATION_HAL_LINK_INDEX_NEXT)
}

func (o ReadOneDigitalWalletCredential200Response) GetPaginationNextLink() LinksHATEOASValue {
	return o.getHalLink(PAGINATION_HAL_LINK_INDEX_NEXT)
}

func (o ReadOneDigitalWalletCredential200Response) GetPaginationNextLinkOk() (*LinksHATEOASValue, bool) {
	return o.getHalLinkOk(PAGINATION_HAL_LINK_INDEX_NEXT)
}

func (o ReadOneDigitalWalletCredential200Response) HasPaginationPrevious() bool {
	return o.hasHalLink(PAGINATION_HAL_LINK_INDEX_PREV)
}

func (o ReadOneDigitalWalletCredential200Response) GetPaginationPreviousLink() LinksHATEOASValue {
	return o.getHalLink(PAGINATION_HAL_LINK_INDEX_PREV)
}

func (o ReadOneDigitalWalletCredential200Response) GetPaginationPreviousLinkOk() (*LinksHATEOASValue, bool) {
...
func (o *ReadOneDigitalWalletCredential200Response) GetEmbedded() ReadOneDigitalWalletCredential200ResponseEmbedded {
	if o == nil || IsNil(o.Embedded) {
		var ret ReadOneDigitalWalletCredential200ResponseEmbedded
		return ret
	}
	return *o.Embedded
}
...
// SetEmbedded gets a reference to the given ReadOneDigitalWalletCredential200ResponseEmbedded and assigns it to the Embedded field.
...
func (o ReadOneDigitalWalletCredential200Response) MarshalJSON() ([]byte, error) {
...
func (o ReadOneDigitalWalletCredential200Response) ToMap() (map[string]interface{}, error) {
...
type NullableReadOneDigitalWalletCredential200Response struct {
	value *ReadOneDigitalWalletCredential200Response
	isSet bool
}

func (v NullableReadOneDigitalWalletCredential200Response) Get() *ReadOneDigitalWalletCredential200Response {
	return v.value
}

func (v *NullableReadOneDigitalWalletCredential200Response) Set(val *ReadOneDigitalWalletCredential200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableReadOneDigitalWalletCredential200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableReadOneDigitalWalletCredential200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadOneDigitalWalletCredential200Response(val *ReadOneDigitalWalletCredential200Response) *NullableReadOneDigitalWalletCredential200Response {
	return &NullableReadOneDigitalWalletCredential200Response{value: val, isSet: true}
}

func (v NullableReadOneDigitalWalletCredential200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadOneDigitalWalletCredential200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
