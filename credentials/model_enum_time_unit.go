...
// EnumTimeUnit Time unit of transaction timeout; can be SECONDS, MINUTES, HOURS, or DAYS.
...
const (
	...
	ENUMTIMEUNIT_HOURS   EnumTimeUnit = "HOURS"
	ENUMTIMEUNIT_DAYS    EnumTimeUnit = "DAYS"
)
