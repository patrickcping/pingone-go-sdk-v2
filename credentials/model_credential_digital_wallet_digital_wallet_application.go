...
type _CredentialDigitalWalletDigitalWalletApplication CredentialDigitalWalletDigitalWalletApplication
...
func (o *CredentialDigitalWalletDigitalWalletApplication) UnmarshalJSON(data []byte) (err error) {
	...
	varCredentialDigitalWalletDigitalWalletApplication := _CredentialDigitalWalletDigitalWalletApplication{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	// decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCredentialDigitalWalletDigitalWalletApplication)

	if err != nil {
		return err
	}

	*o = CredentialDigitalWalletDigitalWalletApplication(varCredentialDigitalWalletDigitalWalletApplication)
