...
type _CredentialIssuanceRuleUsageInnerUser CredentialIssuanceRuleUsageInnerUser
...
func (o *CredentialIssuanceRuleUsageInnerUser) UnmarshalJSON(data []byte) (err error) {
	...
	varCredentialIssuanceRuleUsageInnerUser := _CredentialIssuanceRuleUsageInnerUser{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	// decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCredentialIssuanceRuleUsageInnerUser)

	if err != nil {
		return err
	}

	*o = CredentialIssuanceRuleUsageInnerUser(varCredentialIssuanceRuleUsageInnerUser)
