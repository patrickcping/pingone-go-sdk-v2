...
For using other server than the one defined on index 0 set context value `credentials.ContextServerIndex` of type `int`.
...
Templated server URL is formatted using default variables from configuration or from context value `credentials.ContextServerVariables` of type `map[string]string`.
...
Similar rules for overriding default operation server index and variables applies by using `credentials.ContextOperationServerIndices` and `credentials.ContextOperationServerVariables` context maps.
...
## Documentation For Models
 ...
 - [ReadAllCredentialIssuanceRules200Response](docs/ReadAllCredentialIssuanceRules200Response.md)
 - [ReadAllCredentialIssuanceRules200ResponseEmbedded](docs/ReadAllCredentialIssuanceRules200ResponseEmbedded.md)
 - [ReadAllCredentialTypes200Response](docs/ReadAllCredentialTypes200Response.md)
 - [ReadAllCredentialTypes200ResponseEmbedded](docs/ReadAllCredentialTypes200ResponseEmbedded.md)
 - [ReadAllDigitalWalletApps200Response](docs/ReadAllDigitalWalletApps200Response.md)
 - [ReadAllDigitalWalletApps200ResponseEmbedded](docs/ReadAllDigitalWalletApps200ResponseEmbedded.md)
 - [ReadAllDigitalWallets200Response](docs/ReadAllDigitalWallets200Response.md)
 - [ReadAllDigitalWallets200ResponseEmbedded](docs/ReadAllDigitalWallets200ResponseEmbedded.md)
 - [ReadAllUserCredentials200Response](docs/ReadAllUserCredentials200Response.md)
 - [ReadAllUserCredentials200ResponseEmbedded](docs/ReadAllUserCredentials200ResponseEmbedded.md)
 - [ReadOneDigitalWalletCredential200Response](docs/ReadOneDigitalWalletCredential200Response.md)
 - [ReadOneDigitalWalletCredential200ResponseEmbedded](docs/ReadOneDigitalWalletCredential200ResponseEmbedded.md)
...
```go
auth := context.WithValue(context.Background(), credentials.ContextAccessToken, "BEARER_TOKEN_STRING")
