...
type _CredentialTypeMetaDataFieldsInner CredentialTypeMetaDataFieldsInner
...
func (o *CredentialTypeMetaDataFieldsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varCredentialTypeMetaDataFieldsInner := _CredentialTypeMetaDataFieldsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	// decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCredentialTypeMetaDataFieldsInner)

	if err != nil {
		return err
	}

	*o = CredentialTypeMetaDataFieldsInner(varCredentialTypeMetaDataFieldsInner)
