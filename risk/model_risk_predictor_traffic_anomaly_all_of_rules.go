...
func (o *RiskPredictorTrafficAnomalyAllOfRules) UnmarshalJSON(data []byte) (err error) {
	...
	varRiskPredictorTrafficAnomalyAllOfRules := _RiskPredictorTrafficAnomalyAllOfRules{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	// decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRiskPredictorTrafficAnomalyAllOfRules)

	if err != nil {
		return err
	}

	*o = RiskPredictorTrafficAnomalyAllOfRules(varRiskPredictorTrafficAnomalyAllOfRules)
