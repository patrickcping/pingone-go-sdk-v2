...
// checks if the RiskPredictorAdversaryInTheMiddle type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RiskPredictorAdversaryInTheMiddle{}
...
type _RiskPredictorAdversaryInTheMiddle RiskPredictorAdversaryInTheMiddle
...
func NewRiskPredictorAdversaryInTheMiddle(name string, compactName string, type_ EnumPredictorType) *RiskPredictorAdversaryInTheMiddle {
	this := RiskPredictorAdversaryInTheMiddle{}
	this.Name = name
...
func (o RiskPredictorAdversaryInTheMiddle) hasHalLink(linkIndex string) bool {
...
func (o RiskPredictorAdversaryInTheMiddle) getHalLink(linkIndex string) LinksHATEOASValue {
	if l, ok := o.GetLinksOk(); ok && l != nil {
		links := l
		if v, ok := links[linkIndex]; ok {
			return v
...
func (o RiskPredictorAdversaryInTheMiddle) getHalLinkOk(linkIndex string) (*LinksHATEOASValue, bool) {
	if l, ok := o.GetLinksOk(); ok && l != nil {
		links := l
		if v, ok := links[linkIndex]; ok {
			return &v, true
...
func (o RiskPredictorAdversaryInTheMiddle) IsPaginated() bool {
	return o.hasHalLink(PAGINATION_HAL_LINK_INDEX_NEXT) || o.hasHalLink(PAGINATION_HAL_LINK_INDEX_PREV)
}

func (o RiskPredictorAdversaryInTheMiddle) HasPaginationSelf() bool {
	return o.hasHalLink(PAGINATION_HAL_LINK_INDEX_SELF)
}

func (o RiskPredictorAdversaryInTheMiddle) GetPaginationSelfLink() LinksHATEOASValue {
	return o.getHalLink(PAGINATION_HAL_LINK_INDEX_SELF)
}

func (o RiskPredictorAdversaryInTheMiddle) GetPaginationSelfLinkOk() (*LinksHATEOASValue, bool) {
	return o.getHalLinkOk(PAGINATION_HAL_LINK_INDEX_SELF)
}

func (o RiskPredictorAdversaryInTheMiddle) HasPaginationNext() bool {
	return o.hasHalLink(PAGINATION_HAL_LINK_INDEX_NEXT)
}

func (o RiskPredictorAdversaryInTheMiddle) GetPaginationNextLink() LinksHATEOASValue {
	return o.getHalLink(PAGINATION_HAL_LINK_INDEX_NEXT)
}

func (o RiskPredictorAdversaryInTheMiddle) GetPaginationNextLinkOk() (*LinksHATEOASValue, bool) {
	return o.getHalLinkOk(PAGINATION_HAL_LINK_INDEX_NEXT)
}

func (o RiskPredictorAdversaryInTheMiddle) HasPaginationPrevious() bool {
	return o.hasHalLink(PAGINATION_HAL_LINK_INDEX_PREV)
}

func (o RiskPredictorAdversaryInTheMiddle) GetPaginationPreviousLink() LinksHATEOASValue {
	return o.getHalLink(PAGINATION_HAL_LINK_INDEX_PREV)
}

func (o RiskPredictorAdversaryInTheMiddle) GetPaginationPreviousLinkOk() (*LinksHATEOASValue, bool) {
...
func (o *RiskPredictorAdversaryInTheMiddle) UnmarshalJSON(data []byte) (err error) {
	...
	varRiskPredictorAdversaryInTheMiddle := _RiskPredictorAdversaryInTheMiddle{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	// decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRiskPredictorAdversaryInTheMiddle)

	if err != nil {
		return err
	}

	*o = RiskPredictorAdversaryInTheMiddle(varRiskPredictorAdversaryInTheMiddle)

	return err
}

type NullableRiskPredictorAdversaryInTheMiddle struct {
	value *RiskPredictorAdversaryInTheMiddle
	isSet bool
}

func (v NullableRiskPredictorAdversaryInTheMiddle) Get() *RiskPredictorAdversaryInTheMiddle {
	return v.value
}

func (v *NullableRiskPredictorAdversaryInTheMiddle) Set(val *RiskPredictorAdversaryInTheMiddle) {
	v.value = val
	v.isSet = true
}

func (v NullableRiskPredictorAdversaryInTheMiddle) IsSet() bool {
	return v.isSet
}

func (v *NullableRiskPredictorAdversaryInTheMiddle) Unset() {
	v.value = nil
	v.isSet = false
}
...
func NewNullableRiskPredictorAdversaryInTheMiddle(val *RiskPredictorAdversaryInTheMiddle) *NullableRiskPredictorAdversaryInTheMiddle {
	return &NullableRiskPredictorAdversaryInTheMiddle{value: val, isSet: true}
}

func (v NullableRiskPredictorAdversaryInTheMiddle) MarshalJSON() ([]byte, error) {
