...
type _RiskPredictorBotDetection RiskPredictorBotDetection
...
func (o RiskPredictorBotDetection) hasHalLink(linkIndex string) bool {
...
func (o RiskPredictorBotDetection) getHalLink(linkIndex string) LinksHATEOASValue {
	if l, ok := o.GetLinksOk(); ok && l != nil {
		links := l
		if v, ok := links[linkIndex]; ok {
			return v
...
func (o RiskPredictorBotDetection) getHalLinkOk(linkIndex string) (*LinksHATEOASValue, bool) {
	if l, ok := o.GetLinksOk(); ok && l != nil {
		links := l
		if v, ok := links[linkIndex]; ok {
			return &v, true
...
func (o RiskPredictorBotDetection) IsPaginated() bool {
	return o.hasHalLink(PAGINATION_HAL_LINK_INDEX_NEXT) || o.hasHalLink(PAGINATION_HAL_LINK_INDEX_PREV)
}

func (o RiskPredictorBotDetection) HasPaginationSelf() bool {
	return o.hasHalLink(PAGINATION_HAL_LINK_INDEX_SELF)
}

func (o RiskPredictorBotDetection) GetPaginationSelfLink() LinksHATEOASValue {
	return o.getHalLink(PAGINATION_HAL_LINK_INDEX_SELF)
}

func (o RiskPredictorBotDetection) GetPaginationSelfLinkOk() (*LinksHATEOASValue, bool) {
	return o.getHalLinkOk(PAGINATION_HAL_LINK_INDEX_SELF)
}

func (o RiskPredictorBotDetection) HasPaginationNext() bool {
	return o.hasHalLink(PAGINATION_HAL_LINK_INDEX_NEXT)
}

func (o RiskPredictorBotDetection) GetPaginationNextLink() LinksHATEOASValue {
	return o.getHalLink(PAGINATION_HAL_LINK_INDEX_NEXT)
}

func (o RiskPredictorBotDetection) GetPaginationNextLinkOk() (*LinksHATEOASValue, bool) {
	return o.getHalLinkOk(PAGINATION_HAL_LINK_INDEX_NEXT)
}

func (o RiskPredictorBotDetection) HasPaginationPrevious() bool {
	return o.hasHalLink(PAGINATION_HAL_LINK_INDEX_PREV)
}

func (o RiskPredictorBotDetection) GetPaginationPreviousLink() LinksHATEOASValue {
	return o.getHalLink(PAGINATION_HAL_LINK_INDEX_PREV)
}

func (o RiskPredictorBotDetection) GetPaginationPreviousLinkOk() (*LinksHATEOASValue, bool) {
...
func (o *RiskPredictorBotDetection) UnmarshalJSON(data []byte) (err error) {
	...
	varRiskPredictorBotDetection := _RiskPredictorBotDetection{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	// decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRiskPredictorBotDetection)

	if err != nil {
		return err
	}

	*o = RiskPredictorBotDetection(varRiskPredictorBotDetection)
