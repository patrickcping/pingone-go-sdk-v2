...
type _RiskPredictorCompositeConditionOneOf RiskPredictorCompositeConditionOneOf
...
func (o *RiskPredictorCompositeConditionOneOf) UnmarshalJSON(data []byte) (err error) {
	...
	varRiskPredictorCompositeConditionOneOf := _RiskPredictorCompositeConditionOneOf{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	// decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRiskPredictorCompositeConditionOneOf)

	if err != nil {
		return err
	}

	*o = RiskPredictorCompositeConditionOneOf(varRiskPredictorCompositeConditionOneOf)
