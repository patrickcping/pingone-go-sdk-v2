...
func (o *RiskPredictorCommonDefault) UnmarshalJSON(data []byte) (err error) {
	...
	varRiskPredictorCommonDefault := _RiskPredictorCommonDefault{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	// decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRiskPredictorCommonDefault)

	if err != nil {
		return err
	}

	*o = RiskPredictorCommonDefault(varRiskPredictorCommonDefault)
