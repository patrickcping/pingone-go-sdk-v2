...
type _RiskPredictorCompositeNot RiskPredictorCompositeNot
...
func (o *RiskPredictorCompositeNot) UnmarshalJSON(data []byte) (err error) {
	...
	varRiskPredictorCompositeNot := _RiskPredictorCompositeNot{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	// decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRiskPredictorCompositeNot)

	if err != nil {
		return err
	}

	*o = RiskPredictorCompositeNot(varRiskPredictorCompositeNot)
