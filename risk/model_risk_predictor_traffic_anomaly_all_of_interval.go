...
type _RiskPredictorTrafficAnomalyAllOfInterval RiskPredictorTrafficAnomalyAllOfInterval
...
func (o *RiskPredictorTrafficAnomalyAllOfInterval) UnmarshalJSON(data []byte) (err error) {
	...
	varRiskPredictorTrafficAnomalyAllOfInterval := _RiskPredictorTrafficAnomalyAllOfInterval{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	// decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRiskPredictorTrafficAnomalyAllOfInterval)

	if err != nil {
		return err
	}

	*o = RiskPredictorTrafficAnomalyAllOfInterval(varRiskPredictorTrafficAnomalyAllOfInterval)
