...
func (o *RiskEvaluationEvent) UnmarshalJSON(data []byte) (err error) {
	...
	varRiskEvaluationEvent := _RiskEvaluationEvent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	// decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRiskEvaluationEvent)

	if err != nil {
		return err
	}

	*o = RiskEvaluationEvent(varRiskEvaluationEvent)
