...
type _RiskPredictorCustomItemIPRange RiskPredictorCustomItemIPRange
...
func (o *RiskPredictorCustomItemIPRange) UnmarshalJSON(data []byte) (err error) {
	...
	varRiskPredictorCustomItemIPRange := _RiskPredictorCustomItemIPRange{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	// decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRiskPredictorCustomItemIPRange)

	if err != nil {
		return err
	}

	*o = RiskPredictorCustomItemIPRange(varRiskPredictorCustomItemIPRange)
