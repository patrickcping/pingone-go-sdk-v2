...
// checks if the RiskPredictorGeovelocity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RiskPredictorGeovelocity{}
...
type _RiskPredictorGeovelocity RiskPredictorGeovelocity
...
func (o RiskPredictorGeovelocity) hasHalLink(linkIndex string) bool {
...
func (o RiskPredictorGeovelocity) getHalLink(linkIndex string) LinksHATEOASValue {
	if l, ok := o.GetLinksOk(); ok && l != nil {
		links := l
		if v, ok := links[linkIndex]; ok {
			return v
...
func (o RiskPredictorGeovelocity) getHalLinkOk(linkIndex string) (*LinksHATEOASValue, bool) {
	if l, ok := o.GetLinksOk(); ok && l != nil {
		links := l
		if v, ok := links[linkIndex]; ok {
			return &v, true
...
func (o RiskPredictorGeovelocity) IsPaginated() bool {
	return o.hasHalLink(PAGINATION_HAL_LINK_INDEX_NEXT) || o.hasHalLink(PAGINATION_HAL_LINK_INDEX_PREV)
}

func (o RiskPredictorGeovelocity) HasPaginationSelf() bool {
	return o.hasHalLink(PAGINATION_HAL_LINK_INDEX_SELF)
}

func (o RiskPredictorGeovelocity) GetPaginationSelfLink() LinksHATEOASValue {
	return o.getHalLink(PAGINATION_HAL_LINK_INDEX_SELF)
}

func (o RiskPredictorGeovelocity) GetPaginationSelfLinkOk() (*LinksHATEOASValue, bool) {
	return o.getHalLinkOk(PAGINATION_HAL_LINK_INDEX_SELF)
}

func (o RiskPredictorGeovelocity) HasPaginationNext() bool {
	return o.hasHalLink(PAGINATION_HAL_LINK_INDEX_NEXT)
}

func (o RiskPredictorGeovelocity) GetPaginationNextLink() LinksHATEOASValue {
	return o.getHalLink(PAGINATION_HAL_LINK_INDEX_NEXT)
}

func (o RiskPredictorGeovelocity) GetPaginationNextLinkOk() (*LinksHATEOASValue, bool) {
	return o.getHalLinkOk(PAGINATION_HAL_LINK_INDEX_NEXT)
}

func (o RiskPredictorGeovelocity) HasPaginationPrevious() bool {
	return o.hasHalLink(PAGINATION_HAL_LINK_INDEX_PREV)
}

func (o RiskPredictorGeovelocity) GetPaginationPreviousLink() LinksHATEOASValue {
	return o.getHalLink(PAGINATION_HAL_LINK_INDEX_PREV)
}

func (o RiskPredictorGeovelocity) GetPaginationPreviousLinkOk() (*LinksHATEOASValue, bool) {
...
func (o *RiskPredictorGeovelocity) UnmarshalJSON(data []byte) (err error) {
	...
	varRiskPredictorGeovelocity := _RiskPredictorGeovelocity{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	// decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRiskPredictorGeovelocity)

	if err != nil {
		return err
	}

	*o = RiskPredictorGeovelocity(varRiskPredictorGeovelocity)

	return err
}

type NullableRiskPredictorGeovelocity struct {
	value *RiskPredictorGeovelocity
	isSet bool
}

func (v NullableRiskPredictorGeovelocity) Get() *RiskPredictorGeovelocity {
	return v.value
}

func (v *NullableRiskPredictorGeovelocity) Set(val *RiskPredictorGeovelocity) {
	v.value = val
	v.isSet = true
}

func (v NullableRiskPredictorGeovelocity) IsSet() bool {
	return v.isSet
}

func (v *NullableRiskPredictorGeovelocity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRiskPredictorGeovelocity(val *RiskPredictorGeovelocity) *NullableRiskPredictorGeovelocity {
	return &NullableRiskPredictorGeovelocity{value: val, isSet: true}
}
