...
// checks if the RiskEvaluationDetailsUserVelocityByIpVelocity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RiskEvaluationDetailsUserVelocityByIpVelocity{}
