...
type _OTPDeviceConfigurationOtp OTPDeviceConfigurationOtp
...
func (o *OTPDeviceConfigurationOtp) UnmarshalJSON(data []byte) (err error) {
	...
	varOTPDeviceConfigurationOtp := _OTPDeviceConfigurationOtp{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	// decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOTPDeviceConfigurationOtp)

	if err != nil {
		return err
	}

	*o = OTPDeviceConfigurationOtp(varOTPDeviceConfigurationOtp)
