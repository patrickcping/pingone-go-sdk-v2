...
type _TransactionConfigurationDataCollectionTimeout TransactionConfigurationDataCollectionTimeout
...
func (o *TransactionConfigurationDataCollectionTimeout) UnmarshalJSON(data []byte) (err error) {
	...
	varTransactionConfigurationDataCollectionTimeout := _TransactionConfigurationDataCollectionTimeout{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	// decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTransactionConfigurationDataCollectionTimeout)

	if err != nil {
		return err
	}

	*o = TransactionConfigurationDataCollectionTimeout(varTransactionConfigurationDataCollectionTimeout)
