...
*/
func (a *VoicePhrasesApiService) ReadAllVoicePhraseContents(ctx context.Context, environmentID string, voicePhraseID string) ApiReadAllVoicePhraseContentsRequest {
	return ApiReadAllVoicePhraseContentsRequest{
		ApiService: a,
		ctx: ctx,
		environmentID: environmentID,
...
// Execute executes the request
//  @return EntityArray
func (a *VoicePhrasesApiService) ReadAllVoicePhraseContentsExecute(r ApiReadAllVoicePhraseContentsRequest) (*EntityArray, *http.Response, error) {
	var (
		err                  error
		response             *http.Response
...
func (a *VoicePhrasesApiService) internalReadAllVoicePhraseContentsExecute(r ApiReadAllVoicePhraseContentsRequest) (*EntityArray, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VoicePhrasesApiService.ReadAllVoicePhraseContents")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
