...
For using other server than the one defined on index 0 set context value `verify.ContextServerIndex` of type `int`.
...
Templated server URL is formatted using default variables from configuration or from context value `verify.ContextServerVariables` of type `map[string]string`.
...
Similar rules for overriding default operation server index and variables applies by using `verify.ContextOperationServerIndices` and `verify.ContextOperationServerVariables` context maps.
...
## Documentation For Models
 ...
 - [ReadAllVerifyPolicies200Response](docs/ReadAllVerifyPolicies200Response.md)
 - [ReadAllVerifyPolicies200ResponseEmbedded](docs/ReadAllVerifyPolicies200ResponseEmbedded.md)
 - [ReadAllVoicePhraseContents200Response](docs/ReadAllVoicePhraseContents200Response.md)
 - [ReadAllVoicePhraseContents200ResponseEmbedded](docs/ReadAllVoicePhraseContents200ResponseEmbedded.md)
 - [ReadAllVoicePhrases200Response](docs/ReadAllVoicePhrases200Response.md)
 - [ReadAllVoicePhrases200ResponseEmbedded](docs/ReadAllVoicePhrases200ResponseEmbedded.md)
...
```go
auth := context.WithValue(context.Background(), verify.ContextAccessToken, "BEARER_TOKEN_STRING")
