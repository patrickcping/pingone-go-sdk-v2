...
* `github.com/patrickcping/pingone-go-sdk-v2/management` : [v0.12.0](./management/CHANGELOG.md)
    * **Breaking change** Removed the `EnumLicensePackage` enum model [#79](https://github.com/patrickcping/pingone-go-sdk-v2/pull/79)
    ...
    * **Enhancement** Added the `TERMINATED` value to the `EnumLicenseStatus` model [#79](https://github.com/patrickcping/pingone-go-sdk-v2/pull/79)
