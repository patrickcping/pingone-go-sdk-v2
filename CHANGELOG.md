...
* `github.com/patrickcping/pingone-go-sdk-v2/management` : [v0.13.0](./management/CHANGELOG.md)
    ...
    * **Enhancement** Add support for `AllowWildcardInRedirectUris` property on the `ApplicationOIDC` model [#91](https://github.com/patrickcping/pingone-go-sdk-v2/pull/91)
    ...
    * **Enhancement** Add support for `HomePageUrl` property on the `ApplicationSAML` model [#94](https://github.com/patrickcping/pingone-go-sdk-v2/pull/94)
